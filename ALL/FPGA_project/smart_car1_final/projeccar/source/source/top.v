...
(
    ...
    input        left_detector,  // 左循迹传感器 
    input        right_detector, // 右循迹传感器 
...
always @(posedge clk or negedge sys_rst_n) begin
    ...
    //蓝牙控车模式 灯灭
        ...
        led <= 1'b0;//	
	else if(inf_data == 8'h45    )
        led <= 1'b1;// 	  
	else if(inf_data == 8'h15)
        led <= 1'b0;//  
end
