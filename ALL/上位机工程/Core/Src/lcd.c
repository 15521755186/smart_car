...
void show_pic_car(u16 x,u16 y)
{
	u16 m,h;
	u16 *data=(u16*)gImage_car;
	for(h=0+y;h<234+y;h++)
	{
		for(m=0+x;m<200+x;m++)
		{
...
void show_pic_arm(u16 x,u16 y)
{
	u16 m,h;
	u16 *data=(u16*)gImage_arm;
	for(h=0+y;h<236+y;h++)
	{
		for(m=0+x;m<200+x;m++)
		{
...
void Chinese_Show_one(u16 x, u16 y, u8 num, u8 size, u8 mode)
{
    u8 temp,t,t1;
    u16 y0=y;
